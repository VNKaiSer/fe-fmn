  ...
  <section class="py-24 relative">
    <div class="w-full max-w-7xl px-4 md:px-5 lg-6 mx-auto">
      ...
      <p class="mt-4 font-normal text-lg leading-8 text-gray-500 mb-11 text-center">
        Cảm ơn bạn đã sử dụng dịch vụ của sân bóng Bạch Trữ
      </p>
      <div
        ...
        >
          <div class="data">
            <p class="font-semibold text-base leading-7 text-black">
              Mã đặt sân: <span class="text-indigo-600 font-medium">#10234987</span>
            </p>
            <p class="font-semibold text-base leading-7 text-black mt-4">
              Ngày đặt sân : <span class="text-gray-400 font-medium"> 02/03/2022</span>
            </p>
          </div>
          <button
            ...
            <div class="flex flex-row items-center w-full">
              <div class="grid grid-cols-1 lg:grid-cols-2 w-full">
                <div class="flex items-center">
                  <div class="">
                    <h2 class="font-semibold text-xl leading-8 text-black mb-3">Sân bóng A5.1</h2>
                    <p class="font-normal text-lg leading-8 text-gray-500 mb-3">Loại sân: Sân 5</p>
                    <div class="flex items-center">
                      <p
                        class="font-medium text-base leading-7 text-black pr-4 mr-4 border-r border-gray-200"
                      >
                        Số người: <span class="text-gray-500">5</span>
                      </p>
                      <p class="font-medium text-base leading-7 text-black">
                        Dịch vụ thêm: <span class="text-gray-500">2</span>
                      </p>
                    </div>
                  </div>
                </div>
                <div class="grid grid-cols-5">
                  <div class="col-span-5 lg:col-span-1 flex items-center max-lg:mt-3">
                    <div class="flex gap-3 lg:block">
                      ...
                      <p class="lg:mt-4 font-medium text-sm leading-7 text-indigo-600">250.000₫</p>
                    </div>
                  </div>
              ...
              <div class="grid grid-cols-1 lg:grid-cols-2 w-full">
                <div class="flex items-center">
                  <div class="">
                    ...
                    <p class="font-normal text-lg leading-8 text-gray-500 mb-3">Diamond Dials</p>
                    <div class="flex items-center">
                      <p
                        class="font-medium text-base leading-7 text-black pr-4 mr-4 border-r border-gray-200"
                      >
